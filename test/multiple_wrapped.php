						...
						<div id="collapse_pools" class="panel-collapse collapse">
							<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<button type="button" class="btn btn-info btn-sm btn-block">Add App Pool</button>
									</div>
									<div class="col-md-4"></div>
								</div>
							</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title text-center">
								<a data-toggle="collapse" href="#collapse_site1"><strong>Site 1</strong></a>
							</h4>
						</div>
						<div id="collapse_site1" class="panel-collapse collapse">
							<div class="panel-body">
								<div class="panel-group">
									<div class="panel panel-info">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" href="#collapse_site1_info">Site Information</a>
											</h4>
										</div>
										<div id="collapse_site1_info" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="form-group">
													<label>Site Name:</label>
													<input type="text" class="form-control" name="site[name]" placeholder="Enter site name">
									...
									<div class="panel panel-info">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" href="#collapse_site1_pools">Application Pools</a>
											</h4>
										</div>
										<div id="collapse_site1_pools" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="row">
													<div class="col-md-4"></div>
													<div class="col-md-4">
												...
												<div class="panel-group">
													<div class="panel panel-default">
														<div class="panel-heading">
															<h4 class="panel-title text-center">
																<a data-toggle="collapse" href="#collapse_site1_pools_pool1"><strong>Pool 1</strong></a>
															</h4>
														</div>
														<div id="collapse_site1_pools_pool1" class="panel-collapse collapse">
															<div class="panel-body">
																<div class="panel-group">
																	<div class="panel-body">
																		<div class="form-group">
									...
									<div class="panel panel-info">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" href="#collapse_site1_dirs">Virtual Directories</a>
											</h4>
										</div>
										<div id="collapse_site1_dirs" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="row">
													<div class="col-md-4"></div>
													<div class="col-md-4">
												...
												<div class="panel-group">
													<div class="panel panel-default">
														<div class="panel-heading">
															<h4 class="panel-title text-center">
																<a data-toggle="collapse" href="#collapse_site1_dirs_dir1"><strong>Dir 1</strong></a>
															</h4>
														</div>
														<div id="collapse_site1_dirs_dir1" class="panel-collapse collapse">
															<div class="panel-body">
																<div class="panel-group">
																	<div class="panel-body">
																		<div class="form-group">
									...
									<div class="panel panel-info">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" href="#collapse_site1_apps">Applications</a>
											</h4>
										</div>
										<div id="collapse_site1_apps" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="row">
													<div class="col-md-4"></div>
													<div class="col-md-4">
												...
												<div class="panel-group">
													<div class="panel panel-default">
														<div class="panel-heading">
															<h4 class="panel-title text-center">
																<a data-toggle="collapse" href="#collapse_site1_apps_app1"><strong>App 1</strong></a>
															</h4>
														</div>
														<div id="collapse_site1_apps_app1" class="panel-collapse collapse">
															<div class="panel-body">
																<div class="panel-group">
																	<div class="panel-body">
																		<div class="form-group">
